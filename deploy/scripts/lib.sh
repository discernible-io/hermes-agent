...
load_env() {
  ...
  # Operator API stays on 11642. Host 88 is reserved for Telegram webhooks —
  ...
  HERMES_TELEGRAM_PORT="${HERMES_TELEGRAM_PORT:-88}"
  ...
  HERMES_INGRESS_PORT="${HERMES_INGRESS_PORT:-88}"
...
build_hermes_nginx_image() {
  local ingress
  load_env
  ingress="${HERMES_INGRESS_PORT:-88}"
